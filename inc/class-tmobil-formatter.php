...
// set HTML Purifier
require_once TMOBIL_PLUGIN_PATH . 'libs/htmlpurifier-4.6.0/library/HTMLPurifier.safe-includes.php';
require_once TMOBIL_PLUGIN_PATH . 'libs/htmlpurifier-html5/htmlpurifier_html5.php';

if ( ! class_exists( 'TMOBIL_Formatter' ) ) {

    /**
     * TMOBIL_Formatter
     * Contains different methods for formatting exported content
     */
    class TMOBIL_Formatter
    {
        ...
        public static function init_purifier()
        {
            ...
            // extend purifier
            $Html5Purifier = new TMOBIL_Html_Purifier();
            return $Html5Purifier->tmobil_extended_purifier($config);
        }

...
if (!class_exists('TMOBIL_Detect')) {
    ...
    class TMOBIL_Detect {
        ...
        public function detect_device()
        {
            ...
            if (!class_exists('TMOBIL_Mobile_Detect'))
                require_once (TMOBIL_PLUGIN_PATH . 'libs/Mobile-Detect-2.8.12/Mobile_Detect.php');
            $detect = new TMOBIL_Mobile_Detect();
        ...
        {
            $WMobilePackCookie = new TMOBIL_Cookie();
